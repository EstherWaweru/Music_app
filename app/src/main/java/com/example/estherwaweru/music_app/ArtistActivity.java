...
public class ArtistActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Intent mediaIntent=new Intent(ArtistActivity.this,MediaActivity.class);
    ...
    private void checkPermission() {
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE)
            ...
            if(ActivityCompat.shouldShowRequestPermissionRationale(this,Manifest
                ...
                ActivityCompat.requestPermissions(ArtistActivity.this,new String[]
    ...
    //This displays the results of the check permission method
    @Override
...
//This queries the external storage for the artist name and song Uri
