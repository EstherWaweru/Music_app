...
public class MediaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Intent mediaIntent=Song.starter(getApplicationContext(),mSongData.getSongUri(),mSongData.getSongTitle());
                getApplicationContext().startActivity(mediaIntent);
    ...
    //This gives the results of the check permission method
    @Override
 ...
 //This queries the external storage for the song name and songUri
    public void getMusic() {
        ...
        if(songCursor!=null && songCursor.moveToFirst()){
            do{
                ...
                Song s=new Song(null,name,url,null);
                mSong.add(s);
